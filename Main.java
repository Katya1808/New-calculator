...
public class Main {
    ...
    public static String calc(String input) {
        ...
        if(actionIndex==-1){
            String result = "Некорректное выражение";
            return result;
        }
        ...
        if(actionIndex_2!=-1 || data.length > 2){
            String result = "Формат математической операции не удовлетворяет заданию - два операнда и один оператор(+,-,/,*)";
            return result;
        }
        ...
        if(converter.isRoman(data[0]) == converter.isRoman(data[1])){
            ...
            if(isRoman){
                ...
                String result = converter.intToRoman(result);
                return result;
            }
            else{
            ...
            String result = "Числа должны быть в одном формате";
            return result;
        }
    }
}
